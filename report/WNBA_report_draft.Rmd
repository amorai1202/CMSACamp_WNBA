...
-   Variables from PCA results to use in clustering:
    -   x3p, distance, trb, orb, ows, ortg, ft, fg, pts, x3par,
...
- 5 clusters created for both the WNBA and NBA
- Created archetypes by observing and comparing the following statistics from each cluster:
    - Position distribution 
    - Shooting distance
    - Average points
