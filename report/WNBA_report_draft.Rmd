...
author: 
 - Amor Ai^[Carnegie Mellon University, amorai@cmu.edu], Andrew Noecker^[St. Olaf College, noecke2@stolaf.edu], Mykalyster Homberg^[Harvard University, mhombergbertley@college.harvard.edu]
...
Applying a Gaussian Mixture Model to the subset of variables informed by using PCA, 5 clusters were returned for both the WNBA and NBA.

performance-based variables 5 clusters were created for both the WNBA and NBA The full descriptions of the archetypes are displayed below:
...
- *Variables are all player per 100 possession statistics*
...
## 2. Player Comparison: {.tabset .tabset-dropdown}
