...
>     -   Each WNBA player (that has played significant minutes/games) will be matched with 3-5 similar NBA players based SOLELY on their playstyle
...
-   Constructed archetypes by observing and comparing predominantly results or performance-based statistics from each cluster:
    -   Position distribution
    -   Shooting distance
    -   Average points
...
-   Use different distance metric designed to work with probability vectors - SEE RONS REC
-   We could try to evaluate our clusters/comparisons to other people’s
      -   Finding ways to assess the work
-   REVERSE REVERSE
      -   Train on WNBA, see how NBA players are compared
